...
# Configuration Script – AgroSense RTD PT1000 Temperature Sensor - Rev. B

This **Configuration** script is designed for the **AgroSense RTD PT1000 Temperature Sensor** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – AgroSense RTD PT1000 Temperature Sensor Rev. B

Este script de **Configuration** está diseñado para el modelo **AgroSense RTD PT1000 Temperature Sensor** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
