...
# Parsing + Configuration Script – AgroSense RTD PT1000 Temperature Sensor - Rev. B

This **Parsing + Configuration** script is designed for the **AgroSense RTD PT1000 Temperature Sensor** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AgroSense RTD PT1000 Temperature Sensor Rev. B

Este script de **Parsing + Configuration** está diseñado para el modelo **AgroSense RTD PT1000 Temperature Sensor** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
